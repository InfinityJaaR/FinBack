    ...
    public function run()
    {
        $definitions = [
            ...
            [
                ...
                'componentes' => [
                    ['concepto_codigo' => 'ACT_COR', 'rol' => 'NUMERADOR', 'orden' => 1, 'requiere_promedio' => false, 'sentido' => 1],
                    ['concepto_codigo' => 'PAS_COR', 'rol' => 'OPERANDO', 'orden' => 2, 'requiere_promedio' => false, 'sentido' => -1],
                ],
            ],
            [
                'codigo' => 'ACT_NETO_TRABAJO',
                'nombre' => 'Activo Neto de Trabajo',
                'formula' => 'Activo Corriente - Pasivo Corriente',
                'sentido' => 'MAYOR_MEJOR',
                'categoria' => 'LIQUIDEZ',
                'multiplicador' => 1.0,
            ...
            [
                ...
                'is_protected' => true,
                'componentes' => [
                    ['concepto_codigo' => 'PAS_TOTAL', 'rol' => 'NUMERADOR', 'orden' => 1, 'requiere_promedio' => false, 'sentido' => 1],
                    ['concepto_codigo' => 'ACT_TOTAL', 'rol' => 'DENOMINADOR', 'orden' => 1, 'requiere_promedio' => false, 'sentido' => 1],
                ],
            ],
            [
                'codigo' => 'GRADO_PROPIEDAD',
                'nombre' => 'Grado de Propiedad',
                ...
                'is_protected' => true,
                'componentes' => [
                    ['concepto_codigo' => 'PATRIMONIO', 'rol' => 'NUMERADOR', 'orden' => 1, 'requiere_promedio' => false, 'sentido' => 1],
                    ['concepto_codigo' => 'ACT_TOTAL', 'rol' => 'DENOMINADOR', 'orden' => 1, 'requiere_promedio' => false, 'sentido' => 1],
                ],
            ],
            [
                'codigo' => 'ENDEUDAMIENTO_PAT',
                ...
                'componentes' => [
                    ['concepto_codigo' => 'PAS_TOTAL', 'rol' => 'NUMERADOR', 'orden' => 1, 'requiere_promedio' => false, 'sentido' => 1],
                    ['concepto_codigo' => 'PATRIMONIO', 'rol' => 'DENOMINADOR', 'orden' => 1, 'requiere_promedio' => false, 'sentido' => 1],
                ],
            ],    
        ];
